...
//if (portal=="Schomp" || portal=="schomp") {
	//WebUI.navigateToUrl('https://mango-rewrite-schomp-qa.herokuapp.com/vehicle-service-protection')
	//baseURL='https://mango-rewrite-schomp-qa.herokuapp.com/vehicle-service-protection'
	//}
...
//		totalrate=WebUI.getText((findTestObject('Object Repository/Vroom/CartTotal_rates')))
		...
		WebUI.delay(1)
		WebUI.click(findTestObject('Object Repository/V_ReWrite/Page_Vroom - Get Rates/input__registrationFormAddress'))
...
if(status=='Pass')
{
	WebUI.verifyElementPresent(findTestObject('Object Repository/Vroom/p_order_id'), 5)

	customerOrderNo=WebUI.getText(findTestObject('Object Repository/Vroom/p_order_id')).substring(9)
