...
if (portal.equalsIgnoreCase('nissan') && portal_type.equalsIgnoreCase('asp')) {
	//if(portal_type.equalsIgnoreCase('asp')) 
		println(portal_type)
	WebUI.navigateToUrl('https://mango-rewrite-nissan-qa.herokuapp.com/added-security-plan?oid='+oid)
	baseURL='https://mango-rewrite-nissan-qa.herokuapp.com/'
	
}else if (portal.equalsIgnoreCase('nissan') && portal_type.equalsIgnoreCase('ppm')) {
	//if(portal_type.equalsIgnoreCase('ppm')) 
	WebUI.navigateToUrl('https://mango-rewrite-nissan-qa.herokuapp.com/prepaid-maintenance?oid='+oid)
	baseURL='https://mango-rewrite-nissan-qa.herokuapp.com/'
}
...
if(status=='Pass') {
	try {
		...
		WebUI.delay(30)
		WebUI.click(findTestObject('Object Repository/Nissan/span_Pay Now'))
