...
//
//			excelKeywords.deleteExcel(System.getProperty('user.dir'), 'Result - Prod.xlsx', 'Vroom_Result');
//		}
...
WebUI.delay(7)
if ((WebUI.getUrl() != ((('https://www.oneprotectplans.com/my-vsp-pricing')))))
...
//			(valueToWrite[26]) = eightth_query_result
		...
		ExcelKeywords excelKeywords = new ExcelKeywords()
		 if (portal=="Schomp" || portal=="schomp") {
			excelKeywords.writeExcel(System.getProperty('user.dir'), 'Result - Prod.xlsx', 'Schomp_Result', valueToWrite)
